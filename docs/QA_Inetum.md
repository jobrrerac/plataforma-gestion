...
1. **Manual** — cómo funciona el sistema, las reglas que no deben romperse y
   dónde ya han aparecido errores. Léelo antes de empezar.
2. **Plan de pruebas** — 156 casos con pasos y resultado esperado.
