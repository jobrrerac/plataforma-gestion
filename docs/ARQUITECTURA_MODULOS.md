...
El plan de QA tiene **341 casos**. Repasarlos entero cada vez que se toca una
...
|---|---|---|---|
| `accounts` | AUT, SSO, RBAC | **todo** — es la base de quién puede qué | 283 |
...
| `revision` | HAP | — | 36 |
| `seguimiento` | SEG | DASH (ficha del recurso) | 76 |
