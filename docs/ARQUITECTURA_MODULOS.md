...
El plan de QA tiene **250 casos**. Repasarlos entero cada vez que se toca una
...
|---|---|---|---|
| `accounts` | AUT, SSO, RBAC | **todo** — es la base de quién puede qué | 192 |
...
| `legalizacion` | HOR, HAP, APD | DASH | ~85 |
| `revision` | HAP | — | 36 |
| `dashboard` | DASH | — | 5 |
