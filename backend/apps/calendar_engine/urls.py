...
from .views import FeriadosView, DiasNoHabilesView, DiaNoLaborableViewSet, IndisponibilidadViewSet
...
urlpatterns = router.urls + [
    ...
    path("calendario/dias-no-habiles/", DiasNoHabilesView.as_view(), name="dias-no-habiles"),
]
